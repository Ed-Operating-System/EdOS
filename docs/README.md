# Official Ed Operating-System Documentation Manual

### Last Modified: 25/12/24 (International Date Format)
...
**1. Introduction**
    ...
    1.5 x86_64 Architecture Primer
        ...
        1.5.2 Memory Segmentation
        1.5.3 Paging
        1.5.4 Privilege Levels
        1.5.5 Interrupts
...
Before diving into EdOS internals, you'll need to understand the fundamental concepts of x86_64. This section covers the essential architectural details that will come up repeatedly throughout the boot process and kernel development.
